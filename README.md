...
Ready-for-use шаблон для быстрого старта [aethletic/rick-template](https://github.com/aethletic/rick-template "aethletic/rick-template"). Этот шаблон включает много плюшек "из коробки", классы для работы с пользователями, БД и прочее 👍
